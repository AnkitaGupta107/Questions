# Django settings for Question3 project.
...
SECRET_KEY = '7=q96ep2kc8w(xqr4%v-02qr_*71v(!3tg=$g7@tm4@=zbsd$j'
...
ROOT_URLCONF = 'Question3.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'Question3.wsgi.application'
